...
def get_args(rest_args):
    ...
    parser.add_argument('--beta', type=float, default=0.02, help='KL divergence weight for CVAE')
    ...
    parser.add_argument('--log-interval', type=int, default=100, help='log every # iteration')
    parser.add_argument('--save-interval', type=int, default=10, help='save models interval, every # epoch')
